      ...
      <Container className="text-center mt-4" fluid>
        ...
        <Row className="mb-5">
          <Col xs={6} md={3} className="mb-4">
            <Card style={{ backgroundColor: '#E3D4C5', border: 'none' }}>
        ...
        <Row className="mb-5">
          <Col md={4} className="mb-4">
            <Card style={{ backgroundColor: '#E3D4C5', border: 'none', height: '300px' }}>
              <Card.Body>
                <img
          ...
          <Col md={4} className="mb-4">
            <Card style={{ backgroundColor: '#6F402B', border: 'none', height: '300px', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
              <Card.Body>
        ...
        <Row className="d-flex align-items-center justify-content-center mb-5">
          ...
          <Col md={8} className="mb-5 ">
            <img
              ...
              width={'350'} height={'300px'} className='w-sm-25'
